...
int main(int argc, char **argv) {
    ...
    printf("CPU Version Time: ");
    print(&timer, 0, p.n_reps);
    printf("CPU-DPU Time: ");
    print(&timer, 2, p.n_reps);
    printf("DPU Kernel Time: ");
    print(&timer, 3, p.n_reps);
    printf("Inter-DPU Time: ");
    print(&timer, 1, p.n_reps);
    printf("DPU-CPU Time: ");
    print(&timer, 4, p.n_reps);
    printf("\n");
    printf("Longest Diagonal CPU-DPU Time: ");
    print(&long_diagonal_timer, 2, p.n_reps);
    printf("Longest Diagonal DPU Kernel --Time: ");
    print(&long_diagonal_timer, 3, p.n_reps);
    printf("Longest Diagonal Inter-DPU Time: ");
    print(&long_diagonal_timer, 1, p.n_reps);
    printf("Longest Diagonal DPU-CPU Time: ");
